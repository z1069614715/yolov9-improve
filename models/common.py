...
from models.extra_module.kan_convs import *

try:
    from models.extra_module.ops_dcnv3.modules import DCNv3
except ImportError:
    pass
...
class DRepNCSPELAN4(nn.Module):
    ...
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.c = c3//2
        self.cv1 = Conv(c1, c3, 1, 1)
        self.cv2 = nn.Sequential(RepNCSP(c3//2, c4, c5), DCNv2(c4, c4, 3, 1))
        self.cv3 = nn.Sequential(RepNCSP(c4, c4, c5), DCNv2(c4, c4, 3, 1))
        self.cv4 = Conv(c3+(2*c4), c2, 1, 1)
